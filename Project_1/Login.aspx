<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Project_1.Login" %>
...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2"></td>
                <td class="auto-style2">New to this page ? <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UserRegistration.aspx">Register</asp:HyperLink>
                </td>
                <td class="auto-style2"></td>
                <td class="auto-style2"></td>
                <td class="auto-style2"></td>
