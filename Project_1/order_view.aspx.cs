...
namespace Project_1
{
    public partial class order_view : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string s = "select * from [order] where user_id=" + Session["user_id"] + "";
                ...
                int tp = 0; int gp = 0;
                string s1 = "select sum(p_qty) as tqnty,sum(p_price) as tpr from [order] where user_id=" + Session["user_id"] + "";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string s1 = "select order_date, sum(p_price) as tpr from [order] where user_id=" + Session["user_id"] + " group by order_date";
            ...
            string ins = "insert into bill values('" + date + "'," + Session["user_id"] + "," + tp + ")";
